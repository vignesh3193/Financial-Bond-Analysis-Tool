...
class SBB_yield_curve_input_file {
	public:
		...
		SBB_instrument_fields* curve_records(int& length);
	...
	private:
		...
		// prevent copying
		// 
		SBB_yield_curve_input_file (const SBB_yield_curve_input_file &);
		
		//
		// prevent assignment
		//
		SBB_yield_curve_input_file & operator= (const SBB_yield_curve_input_file &);
